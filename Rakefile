...
task :new do
  ...
  File.open(filename, "w") do | post |
    ...
    post.puts "categories: [ambitions, open-source, programming, studies, \"training journal\", \"training methodology\", trainingprogram, fetich, \"fetich community\", \"fetich clubbing\"]"
    post.puts "tags: [c++, ruby, python, git, vim, ruby-on-rails, bench press]"
    post.puts "---"
    post.puts ""
